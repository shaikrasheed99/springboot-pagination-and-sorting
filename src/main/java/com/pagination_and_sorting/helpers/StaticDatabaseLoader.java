...
public class StaticDatabaseLoader {
    ...
    public CommandLineRunner initDatabase() {
        return args -> {
            String[] names = {"Iron Man", "Thanos", "Captain America", "Thor", "Loki", "Hulk", "Captain Marvel", "Spider Man", "Black Widow", "Hawkeye", "Black Panther", "Doctor Strange", "Ant Man", "Vision", "Hulkbuster", "War Machine", "Nick Fury", "Falcon", "Winter Soldier", "Ultron", "Red Skull" };
